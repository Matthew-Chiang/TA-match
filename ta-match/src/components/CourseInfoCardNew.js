...
export default function CourseInfoCard({
        ...
        fetch(`http://localhost:5000/api/updateTaHours`, {
            ...
            .then((response) => {
                if (response.status == "404") {
                    setError(
                        "Total hours assigned must not exceed number of TA hours"
                    );
                } else {
    ...
    return (
        <div>
                        ...
                        <Grid item xs={4} className={classes.icons}>
                            {!editPrivilege && (
                                <div>
                                    ...
                                    >
                                        {courseState.applicant_list.length}{" "}
                                        Applicants
                                    </span>
                                </div>
                            )}
            ...
            {"allocation_list" in courseState && (
                ...
                >
                    ...
                    <div className={classes.dialogContainer}>
                        <Typography className={classes.dName}>
                            Professor: {courseState["instructor"]}
                        </Typography>
                        <Typography className={classes.dHrs}>
                            <span style={{ fontWeight: "bold" }}>
                                Number of TA Hours:
                            </span>{" "}
                            {courseState["ta_hours"]}
                        </Typography>
                        <Typography className={classes.dCode}>
                            {courseState["course_code"]}:{" "}
                            <span style={{ fontWeight: "normal" }}>
                                {courseState["course_name"]}
                            </span>
                        ...
                        {courseState.allocation_list.length == 0 ? (
                            <Typography>
                                <Box fontStyle="italic">
                                    No TAs have been allocated to this course
                                    yet.
                                </Box>
                            </Typography>
                        ) : (
                        ...
                        {editPrivilege && (
                            <div>
                                ...
                                <TextField
                                    className={classes.allocateTxtField}
                                    variant="outlined"
                                    label="Name"
                                    size="small"
                                    value={addTaName}
            ...
            {"applicant_list" in courseState &&
            courseState.applicant_list.length > 0 ? (
                <Dialog
                    fullScreen
                    open={openCoursePopup}
